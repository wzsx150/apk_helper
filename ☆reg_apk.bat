...
reg query "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.apk\UserChoiceLatest" >nul 2>nul && MinSudo.exe --NoLogo -S reg delete "HKEY_USERS\!sid!\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.apk\UserChoiceLatest" /f
reg query "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.apk\UserChoice" /v "Progid" >nul 2>nul && MinSudo.exe --NoLogo -S reg delete "HKEY_USERS\!sid!\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.apk\UserChoice" /f
...
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.apk\UserChoiceLatest\ProgId" /v "ProgId" /t REG_SZ /d "ApkFile.apkhelper" /f 2>nul
