...
reg query "HKCR\.apk" /ve  2>nul | find /I "ApkFile.apkhelper" 2>nul 1>nul && (
...
reg query "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.apk\UserChoiceLatest\ProgId" /v "ProgId" 2>nul | find /I "ApkFile.apkhelper" >nul 2>nul && (
  MinSudo.exe --NoLogo -S reg delete "HKEY_USERS\!sid!\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.apk\UserChoiceLatest" /f
)
reg query "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.apk\UserChoiceLatest\ProgId" /v "ProgId" 2>nul | find /I "Applications\apk_helper.exe" >nul 2>nul && (
  MinSudo.exe --NoLogo -S reg delete "HKEY_USERS\!sid!\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.apk\UserChoiceLatest" /f
)
reg query "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.apk\UserChoice" /v "Progid" 2>nul | find /I "ApkFile.apkhelper" >nul 2>nul && (
...
reg query "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.apk\UserChoice" /v "Progid" 2>nul | find /I "Applications\apk_helper.exe" >nul 2>nul && (
  MinSudo.exe --NoLogo -S reg delete "HKEY_USERS\!sid!\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.apk\UserChoice" /f
)
